...
I don't know exactly what that says about me. Probably something. But it planted a seed — if I could win knowing nothing, what could I do if I actually tried?
...
175 features engineered from scratch — target share, air yards, EPA per play, referee penalty tendencies, coaching scheme fingerprints, dome vs outdoor splits, travel fatigue, game script adjustments, and about 160 other things that have never appeared on a fantasy cheat sheet.
...
The single most predictive signal across 22 years of data — more powerful than target share, touchdowns, snap counts, or anything else — is what I call the Boom-Consistency Index. Players who score big regularly AND never completely disappear. The market rewards boom. The data rewards boom plus consistency. There's a meaningful difference and most drafters ignore it.

Third down targets — the stat everyone uses to find the quarterback's security blanket — actually predicts LOWER future production. The machine found this independently. I didn't expect it. The data doesn't care what I expected.
...
And 21 of 32 NFL teams changed offensive coordinators this offseason — the most coordinator turnover in NFL history — and virtually every public rankings site is still projecting 2026 performance based on 2025 scheme data that no longer applies. The Gavfather System accounts for every single change with position-specific adjustments based on each new coordinator's actual historical tendencies.
