...
/** FantasyPros affiliate — tools that use this board, not a second cheat sheet. */
export const FP_PARTNER = 'gavfather'
export const FP_EXPERT_ID = '7687'
export const FP_DRAFT_SIMULATOR =
  'https://draftwizard.fantasypros.com/football/mock-draft-simulator/?partner=gavfather'
export const FP_DRAFT_ANALYZER =
  'https://draftwizard.fantasypros.com/football/draft-analyzer/?partner=gavfather'
